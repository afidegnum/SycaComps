...
#[component]
pub fn FormResult<G: Html>(cx: Scope, s: (String, Value)) -> View<G> {
    ...
    view! { cx,
            div (class="mb-3 needs-validation") {
              ...
              input( on:blur=move|_| handle_blur(), bind:value=sample_data,
                     class="form-control", type="image", placeholder=default_value.clone(), required=false, pattern="", minlength=min_length, maxlength=max_length, size="",
