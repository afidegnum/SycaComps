...
#[component]
pub fn TelelphoneInput<G: Html>(cx: Scope, s: (String, Value)) -> View<G> {
    ...
    view! { cx,
            div (class="mb-3 needs-validation") {
              ...
              input( on:blur=move|_| handle_blur(), bind:value=sample_data,
                     class="form-control", type="tel", placeholder=default_value.clone(), required=is_required, /*pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}",*/readonly=false, disabled=false, autofocus=false, autocomplete=""){}
