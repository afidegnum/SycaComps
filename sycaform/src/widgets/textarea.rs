    ...
    view! { cx,
            div (class="mb-3 form-loating needs-validation") {
              ...
              //        readonly=false, disabled=false, autofocus=false, autocomplete=""){}
               ...
               textarea( on:blur=move|_| handle_blur(), bind:value=sample_data, class="form-control", placeholder=ft,  rows="3", minlength=min_length, maxlength=max_length, cols="", required=is_required, readonly=false, disabled=false, autofocus=false)
